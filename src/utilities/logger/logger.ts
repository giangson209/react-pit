...
import { LogBufferRecord, LogLevel, LoggerService } from './type';
...
export class Logger {
  ...
  private static WrapBuffer: MethodDecorator = (target: object, propertyKey: string | symbol, descriptor: TypedPropertyDescriptor<any>) => {
  ...
  constructor(context: string, options?: { timestamp?: boolean; timestampDiff?: boolean });
  constructor(protected context?: string, protected options: { timestamp?: boolean; timestampDiff?: boolean } = {}) {}
  ...
  info(message: any, ...optionalParams: any[]) {
    optionalParams = this.context ? optionalParams.concat(this.context) : optionalParams;
    this.localInstance?.info?.(message, ...optionalParams);
  }
  ...
  private registerLocalInstanceRef() {
    ...
    this.localInstanceRef = new ConsoleLogger(this.context!, {
      ...
      timestampDiff: this.options?.timestampDiff,
